Pod::Spec.new do |s|
    ...
    s.source = { :http => "https://cocoapods.tapkey.com/TapkeyMobileLib/2.39.3.0/TapkeyMobileLib-2.39.3.0.tar.bz2", :sha256 => "cad4c2f9acea1ff9f35a973eebc48b6b2904119b5621f523781e60a092fa7560"}
    s.platforms = { 
        :ios => "11.0",
        :watchos => "6.2"
    }
    ...
    s.subspec 'Core' do |cs|
        ...
        cs.ios.dependency 'SocketRocket', '~> 0.7.0'
